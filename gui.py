...
# Paleta de colores moderna y clara
...
class MazeGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Laberinto - Backtracking Recursivo ")
    ...
    def mostrar_estadisticas(self):
        ...
        tk.Label(
            card_opt,
            text=f"• Salida óptima: {salida_opt}\n"
        ...
        # Botón de Cerrar
        tk.Button(
            ventana, text="Entendido", font=("Segoe UI", 9, "bold"),
